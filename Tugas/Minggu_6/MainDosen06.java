...
public class MainDosen06 {
    public static void main(String[] args) {
        ...
        data.tambah(new Dosen06("D01", "Dr. Budi", true, 45));
        data.tambah(new Dosen06("D02", "Siti Aminah", false, 30));
        data.tambah(new Dosen06("D03", "Andi Wijaya", true, 38));
        ...
        do {
            ...
            switch (pilih) {
                case 1:
                    ...
                    int usia = sc.nextInt();
                    data.tambah(new Dosen06(kd, nm, jk, usia));
                    break;
                case 2:
                    System.out.println("\n--- Daftar Dosen ---");
                    data.tampil();
